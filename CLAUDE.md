...
The public API is the top-level package: `from gradeit import gradeit, GradeResult, USGSApi, USGSLocal, Wood2014Filter, SavitzkyGolayFilter, BridgeFilter, ...` (see `gradeit/__init__.py`). The orchestration lives in `gradeit/core.py`.
